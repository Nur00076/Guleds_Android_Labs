...
import algonquin.cst2335.nur00076.databinding.ActivityReceiveMessageBinding;
...
import algonquin.cst2335.nur00076.databinding.ActivityChatRoomBinding;
import algonquin.cst2335.nur00076.databinding.SentMessageBinding;
        ...
        binding.recycleView.setAdapter(myAdapter = new RecyclerView.Adapter<MyRowHolder>() {
            ...
            public MyRowHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                if (viewType == 0) {
                    ...
                    ActivityReceiveMessageBinding receiveBinding = ActivityReceiveMessageBinding.inflate(getLayoutInflater());
